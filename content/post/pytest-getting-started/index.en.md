...
If your tests need a lot of fake data, [polyfactory]({{< ref "/post/polyfactory-test-data" >}}) generates it from type hints automatically — no hand-crafting fixture data.
