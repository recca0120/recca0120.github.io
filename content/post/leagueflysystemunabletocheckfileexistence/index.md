...
- [Laravel 官方文件：File Storage - S3 Driver](https://laravel.com/docs/filesystem#s3-driver-configuration)
- [League Flysystem 官方文件](https://flysystem.thephpleague.com/docs/)
- [AWS 文件：S3 IAM 權限說明](https://docs.aws.amazon.com/AmazonS3/latest/userguide/using-with-s3-actions.html)
- [Laravel GitHub Issue #45639：S3 exists() 403 問題討論](https://github.com/laravel/framework/issues/45639)
